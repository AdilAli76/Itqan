        ...
        child: Column(
          ...
          children: [
            if (!_done) ...[
              ...
              Text(
                'الأعمدة المدعومة: الاسم* · الهاتف · البريد · الفئة · '
                'نموذج الحساب · سقف الائتمان · أيام السداد · سقف الاستحقاق · '
                'البريد · الملاحظات. والاسم إلزامي، والباقي اختياري.',
  ...
  Future<void> _downloadTemplate() async {
    ...
    try {
      ...
      final path = await FilePicker.saveFile(
        fileName: 'قالب-استيراد-العملاء.xlsx',
