...
const _editionLabels = {
  ...
  'wallet_plus': 'المحفظة بالمحاسبة — بطاقات وأرصدة مع دفتر كامل',
  'pharmacy': 'الصيدليات — متجر كامل + نشرة الدواء',
  'trial': 'تجريبي',
  'enterprise': 'مؤسسات',
};
...
const _editionHints = {
  ...
  'wallet_plus': 'المحفظة نفسها ومعها دليل حسابات ودفتر قيود وميزان '
      'مراجعة وقائمة دخل ومصروفات. لجهةٍ تصرف على منتسبيها وتريد '
      'حساباتها كاملة — بلا مخزون ولا مشتريات.',
  'pharmacy': 'كل وحدات الإصدار القياسي، وفوقها نشرة الدواء: المادة الفعّالة '
      'والتركيز ودواعي الاستعمال وموانعه والتحذيرات — تُعرض للكاشير لحظة الصرف.',
