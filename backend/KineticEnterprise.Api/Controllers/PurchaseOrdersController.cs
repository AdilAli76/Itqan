...
public class PurchaseOrdersController : ControllerBase
{
    ...
    /// <code>
    ///   من ح/ المخزون
    ///       إلى ح/ بضاعة وردت ولم تُفوتَر
    /// </code>
    ///
    /// <para><b>ولماذا «وردت ولم تُفوتَر» لا «الموردون» مباشرةً:</b> كان
    /// الدَّين يُثبَت بورقة أمين المخزن قبل أن تصل ورقة المورّد، وبتكلفة أمر
    /// الشراء لا بما طُولب به فعلاً. فإن اختلف السعران — وهو الغالب — لم يكن
    /// ثمّة موضعٌ يظهر فيه الفرق. الآن يقف المبلغ في حسابٍ وسيط حتى تصل
    /// الفاتورة فتُفرغه إلى «الموردون» (راجع
    /// <see cref="SupplierInvoicesController"/>)، ورصيدُه في أي لحظة هو قيمة
    /// ما في المخزن ولم يُطالِب به المورّد بعد.</para>
    ///
    /// <para><b>وما رُحِّل قبل هذا التغيير يبقى على «الموردون»:</b> لا يُعاد
    /// ترحيله ولا يُصحَّح — حرمة القيد. الشحنات القديمة عوملت كأنها فُوترت
    /// لحظة وصولها، وهذا ما كان.</para>
    ///
