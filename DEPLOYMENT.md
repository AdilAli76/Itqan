...
## 5.5 طريقة تكلفة الصنف

صنفٌ في مخزنه شحنتان بسعرين، وبطاقتُه تعرض **رقماً واحداً**: هو ما يقيس عليه
الحدّ الأدنى للسعر ويُعرض به الهامش. فأيّهما يُقال؟ **الإعدادات ← تكلفة
الصنف**، وثلاثة خيارات:

| الخيار | الرقم | لمن |
|---|---|---|
| **آخر شراء** (الافتراضي) | سعر آخر شحنة محمَّلاً بمصاريفها | «بكم أشتريه اليوم» — الأشيع عند التاجر |
| **المتوسط المرجّح** | قيمة ما في المخزن ÷ كميّته | من يبيع بضاعةً متماثلة من شحناتٍ مختلطة |
| **تكلفة الدفعة** | تكلفة الشحنة التي ستخرج في البيع التالي | من يتتبّع الصلاحية — الوحيد الذي لا يكذب عنده |

> ⚠ **ولا يمسّ أيٌّ منها ربحك المحسوب.** تكلفة البضاعة المباعة تُقرأ من
> الدفعة التي خرجت منها البضاعة فعلاً — الأقدم صلاحيةً (FEFO) أو دخولاً
> (FIFO) — دفعةً دفعة وبتكلفتها هي. وهذا أدقّ من أي متوسط، ولا يتغيّر
> بهذا الإعداد.

**والافتراضي هو سلوك النظام قبل الإعداد**، فلا يتغيّر رقمٌ عند أحد ما لم
يختره بنفسه. ونفّذ `docs\MIGRATIONS.sql` — تُضيف العمود بقيمته الافتراضية.
