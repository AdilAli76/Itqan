...
## 5.2 الطابعات وقسيمة البطاقة

**«عرض الورق ٨٠ ملم» رقمٌ يضلّل.** طابعة NB80 تأخذ لفّةً عرضها ٨٠ ملم وتطبع
على **٧٢** منها؛ والثمانية الباقية حافّتان لا تصلهما رأس الطباعة. فباركودٌ
يُرسم بعرض ٨٠ يخرج مقصوص الطرفين، ولا يقرؤه ماسحٌ ولا كاميرا — بلا رسالة خطأ
ولا سبب ظاهر.

فالنظام يحمل **تعريفات طابعات** لا رقم عرضٍ وحده: NB80، وNB58، وعامّة ٨٠
و٥٨، وطابعة مكتب A4. لكل تعريف عرضُه المطبوع وكثافةُ نقاطه، ومنهما يُحسب
مقاس الباركود.

**والتعريف يُختار على الجهاز لا على المنظمة:** فرعٌ عنده NB80 وآخر عنده ٥٨ ملم
في اللحظة نفسها. يُسأل عنه أوّل طباعةٍ حرارية ثم يُحفظ لذلك الجهاز وحده،
ويُستنتَج قبل ذلك من عرض الإيصال المحفوظ في الإعدادات.

### قسيمة البطاقة

من **بطاقات المحفظة ← بطاقة ← «قسيمة حرارية»**: باركود البطاقة على اللفّة في
ثانيتين، بدل البطاقة ذات الوجهين التي تُطبع على A4 ثم تُقصّ وتُلصق وتُغلَّف.

| اللفّة | العمود النحيف | القارئ |
|---|---|---|
| ٨٠ ملم (NB80) | ٠٫٢٥ ملم — نقطتان | ماسح الليزر **وكاميرا الهاتف** |
| ٥٨ ملم | ٠٫١٢٥ ملم — نقطة واحدة | ماسح الليزر وحده، فيُطبع **QR** معه للكاميرا |

القراءة بالكاميرا موجودة أصلاً في نقطة البيع وشاشة المحفظة (زرّ «مسح
البطاقة»)، وتقرأ الرمزين معاً.

> ⚠ الورق الحراري يبهت في أسابيع — والقسيمة تقول ذلك على نفسها. هي مرحلةٌ
> قبل البطاقة الدائمة لا بديلٌ عنها.
...
## 5.4 وحدة «بطاقات ومرتَّبات المنتسبين»

جهةٌ تبيع بضاعةً **وتصرف على منتسبيها** — محلٌّ عسكري بفروعه الغذائية،
جمعيةٌ تصرف على أعضائها، شركةٌ لموظّفيها — كانت تقع بين إصدارين: النسخة
الكاملة تعطيها البضاعة والمخزون، و«المحفظة بالمحاسبة» تعطيها البطاقات
الجماعية والمرتَّبات وليس فيها بضاعة أصلاً.

فصارت وحدةً تُباع **فوق أي إصدار**: من شاشة المنصّة ← المنظمة ← الترخيص ←
الوحدات ← «بطاقات ومرتَّبات المنتسبين».

**وما تفتحه:**

- الإصدار **الجماعي** للبطاقات (فئةً كاملة أو قائمة عملاء دفعةً واحدة).
- شاشة **المرتَّبات والسلف** في القائمة.

**وما كان مفتوحاً ويبقى:** البطاقة الفردية، وفئات العملاء ومرتَّباتها،
والصرف الجماعي على فئة، والدفع من المحفظة في نقطة البيع، واستيراد المنتسبين
بفئاتهم. لم يكن أيٌّ منها محجوباً في أي إصدار.

> ولا يتغيّر شيء عند عميلٍ قائم: «المحفظة بالمحاسبة» تحمل الوحدة تلقائياً،
> والمحفظة البسيطة تحتفظ بشاشة مرتَّباتها بلا شرائها.

**والسيناريو كاملاً:** فئاتٌ للجنود بمرتَّبٍ لكلٍّ ← استيرادهم بالإكسل ←
إصدار بطاقاتهم دفعةً واحدة ← صرف المرتَّبات شهرياً ← يأخذون بضاعتهم من
الفروع الغذائية ببطاقاتهم فيُخصم من رصيدهم.

---

## 5.5 نشر بناءٍ لم يُوسم (التجربة وحدها)

النشر يأخذ حزمته من **إصدارٍ موسوم** — وهو الأصل، ويبقى كذلك للإنتاج.
لكنّ الوسم قرارٌ لا يُتخذ لتجربة شاشة: يبقى في تاريخ المستودع ويُعلن نسخةً
للناس. فمن أراد تجربة بناءٍ قبل أن يوسمه كان أمامه أن يوسم إصداراً لا ينوي
إصداره، أو يرفع الحزمة بيده — فيفقد ما يحرسه `ci_deploy`: مطابقة البصمة،
وبوّابة الإنتاج، ونقطة التحديث.

فصار لسير **النشر** مدخلٌ ثانٍ: `run_id` — رقم سير «بناء حزمة النشر» تُؤخذ
حزمته من أثره مباشرةً (الرقم في آخر رابط صفحة السير). ومعه `version`
اختياريّ: **وبلاه يُشتقّ من رقم الجولة** — البناء بلا وسم يسمّي نفسه
`0.0.<رقم الجولة>`، فيُعلَن كذلك ويظهر شريط «تحديث متاح» لمن على بناءٍ
أقدم. وهذا ما يجعل نشرة التجربة قابلةً للتمييز أصلاً: بلا إعلانٍ ينشر
المجرِّب ثم يفتح جهازه فلا يرى جديداً — لأن جهازه ما زال على البناء
السابق ولا شيء أخبره.

ولا يُخشى من إعلانه على من هو على إصدارٍ موسوم: المقارنة رقمية، و`0.0.26`
أقدم من `1.6.0` — فلا يُدعى أحدٌ إلى الرجوع إلى الوراء.

| | الوسم | رقم السير |
|---|---|---|
| المصدر | مرفَق الإصدار | أثر السير (ثلاثون يوماً) |
| الإنتاج | نعم | **مرفوض** |
| نقطة التحديث | من الوسم | من `version`، وبلاه `0.0.<رقم الجولة>` |

**ولا يبلغ الإنتاجَ أثرٌ أبداً**: الأثر يُمحى بعد شهر، ورقم السير لا يقول ما
فيه — فلا يبقى بعد شهرين ما يُراجَع به ما يعمل على الخادم. والسكربت يرفضه
هناك صراحةً لا اتّكالاً على الانضباط.

---

## 5.6 استرجاع المحذوف

نافذة الحذف تَعِد بأن «المحذوف يمكن استرجاعه لاحقاً من سجل التدقيق». والوعد
كان يُوفى لاثنين فقط — العميل والصنف — بينما **المورّد والجهة الراعية
محذوفان حذفاً ناعماً**: صفّهما باقٍ في القاعدة بكل حركاته، ولا سبيل في
الواجهة إليه. فمن حذف مورّداً بالخطأ كان أمامه أن يُنشئ غيرَه باسمه، فينفصل
تاريخ المشتريات كلّه عن المورّد الذي يُشترى منه اليوم.

| ما حُذف | في القاعدة | الاسترجاع |
|---|---|---|
| عميل · صنف · **مورّد** · **جهة راعية** | راية `is_deleted` | زرّ الاسترجاع في سجل التدقيق |
| فئة · حساب · مرفق | **الصفّ يُحذف فعلاً** (والمرفق يُمحى ملفّه من القرص) | لا رجعة |

ولا يُوضع في قائمة الاسترجاع ما لا نقطةَ له: زرٌّ يَعِد ثم يردّ الخادم 404
أسوأ من غياب الزرّ — الأوّل يجعل المستخدم يضغط «حذف» مطمئنّاً.

**ومرجع الأدوية** محذوفٌ ناعماً كذلك، لكنّه جدولٌ عامّ لا يخصّ منظمة وحذفُه
لمدير المنصّة وحده ولا يُسجَّل في التدقيق — فلا سطر يحمل زرّاً. استرجاعه
يبقى على القاعدة مباشرةً.
