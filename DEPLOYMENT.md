...
اختياريّ: بلاه يُرقَّى الخادم ويُنسخ تطبيق سطح المكتب **ولا يُخبَر جهازٌ
بتحديث** — وهو المقصود، فبناء التجربة لا يُعلَن نسخةً لأحد.

| | الوسم | رقم السير |
|---|---|---|
| المصدر | مرفَق الإصدار | أثر السير (ثلاثون يوماً) |
| الإنتاج | نعم | **مرفوض** |
| نقطة التحديث | من الوسم | من `version` إن مُرِّر |
